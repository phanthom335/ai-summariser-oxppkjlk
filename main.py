    """
    Ai Summariser Oxppkjlk
    ======================
    Developer-friendly AI library that helps you score documents programmatically.
    ...
    APP_NAME    = "Ai Summariser Oxppkjlk"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly AI library that helps you score documents programmatically.")
